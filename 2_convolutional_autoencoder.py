...
from keras.layers import Input, Dense, Conv2D, MaxPooling2D, UpSampling2D, Flatten, Dropout, Reshape, TimeDistributed
...
inp_hidden = Input( shape=(np.product(pre_flat_shape[1:]),) )
hidden_comp = Dense(encoding_dim)(inp_hidden)
...
seq_hidden = TimeDistributed(hidden_model)(seq_enc)
